import{r as c,j as e,b as p,F as u,R as v}from"./index-DyxG8Fyo.js";import{C as w}from"./clock-QJgUkH1o.js";import{D as j}from"./download-DD1uI97Z.js";function y(o,n){const a=[];n.forEach((i,l)=>{l>0&&a.push(""),a.push(`# ${i.title}`),i.headers&&a.push(i.headers.join(",")),i.rows.forEach(d=>{a.push(d.map(x=>{const s=String(x).replace(/"/g,'""');return s.includes(",")||s.includes('"')||s.includes(`
...
//# sourceMappingURL=HistoryPage-BM13bB6n.js.map
