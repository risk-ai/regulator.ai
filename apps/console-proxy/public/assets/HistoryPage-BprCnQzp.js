import{r as c,j as t,b as x}from"./index-D90LomYO.js";import{P as h}from"./PageLayout-BNSaWtR9.js";function v(a,r){const o=[];r.forEach((n,l)=>{l>0&&o.push(""),o.push(`# ${n.title}`),n.headers&&o.push(n.headers.join(",")),n.rows.forEach(d=>{o.push(d.map(p=>{const s=String(p).replace(/"/g,'""');return s.includes(",")||s.includes('"')||s.includes(`
...
//# sourceMappingURL=HistoryPage-BprCnQzp.js.map
