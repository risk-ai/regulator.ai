import{r as c,j as t,b as x}from"./index-DC57FJhv.js";import{P as h}from"./PageLayout-DjFMLB3k.js";function v(a,r){const o=[];r.forEach((n,l)=>{l>0&&o.push(""),o.push(`# ${n.title}`),n.headers&&o.push(n.headers.join(",")),n.rows.forEach(d=>{o.push(d.map(p=>{const s=String(p).replace(/"/g,'""');return s.includes(",")||s.includes('"')||s.includes(`
...
//# sourceMappingURL=HistoryPage-DuP6DKWx.js.map
