import{r as c,j as t,b as x}from"./index-coLn4rI7.js";import{P as h}from"./PageLayout-qiL1ypiL.js";function v(a,r){const o=[];r.forEach((n,l)=>{l>0&&o.push(""),o.push(`# ${n.title}`),n.headers&&o.push(n.headers.join(",")),n.rows.forEach(d=>{o.push(d.map(p=>{const s=String(p).replace(/"/g,'""');return s.includes(",")||s.includes('"')||s.includes(`
...
//# sourceMappingURL=HistoryPage-_yQCJF8F.js.map
