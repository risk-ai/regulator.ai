...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    Ok(())
}`},b=o=>{c(`Connecting ${o}...`,"info"),setTimeout(()=>{i(g=>g.map(d=>d.id===o?{...d,status:"connected",lastSync:"Just now"}:d)),c(`${o} connected successfully`,"success")},1500)},y=o=>{c(`Testing ${o} connection...`,"info"),setTimeout(()=>{c(`${o} connection healthy`,"success")},1e3)},h=o=>{confirm("Revoke this API key? This cannot be undone.")&&(r(g=>g.filter(d=>d.id!==o)),c("API key revoked","success"))},v=t.filter(o=>o.status==="connected").length;return e.jsxs(w,{title:"",description:"",children:[e.jsx("div",{style:{background:"linear-gradient(180deg, rgba(6, 182, 212, 0.1) 0%, transparent 100%)",borderBottom:"1px solid rgba(251, 191, 36, 0.2)",padding:"20px",marginBottom:"20px"},children:e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[e.jsxs("div",{children:[e.jsx("h1",{style:{fontSize:"24px",fontWeight:700,color:"#06b6d4",margin:0,fontFamily:"var(--font-mono)",letterSpacing:"0.02em"},children:"🔌 INTEGRATIONS"}),e.jsxs("div",{style:{fontSize:"11px",color:"rgba(230, 225, 220, 0.5)",marginTop:"4px",fontFamily:"var(--font-mono)"},children:[v," of ",t.length," integrations connected"]})]}),e.jsxs("button",{onClick:()=>alert("Create new API key coming soon"),style:{padding:"8px 16px",background:"rgba(6, 182, 212, 0.2)",border:"1px solid rgba(6, 182, 212, 0.4)",color:"#06b6d4",fontSize:"10px",fontWeight:700,fontFamily:"var(--font-mono)",cursor:"pointer",letterSpacing:"0.05em",display:"flex",alignItems:"center",gap:"6px"},children:[e.jsx(f,{size:12}),"CREATE API KEY"]})]})}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"24px"},children:[e.jsxs("div",{children:[e.jsx("h2",{style:{fontSize:"14px",fontWeight:700,color:"#fbbf24",marginBottom:"12px",fontFamily:"var(--font-mono)",letterSpacing:"0.05em"},children:"AVAILABLE INTEGRATIONS"}),e.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(300px, 1fr))",gap:"12px"},children:t.map(o=>e.jsx($,{integration:o,onConnect:()=>b(o.id),onTest:()=>y(o.id)},o.id))})]}),e.jsxs("div",{children:[e.jsx("h2",{style:{fontSize:"14px",fontWeight:700,color:"#fbbf24",marginBottom:"12px",fontFamily:"var(--font-mono)",letterSpacing:"0.05em"},children:"API KEYS"}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"8px"},children:n.map(o=>e.jsx(F,{apiKey:o,onRevoke:()=>h(o.id)},o.id))})]}),e.jsxs("div",{children:[e.jsx("h2",{style:{fontSize:"14px",fontWeight:700,color:"#fbbf24",marginBottom:"12px",fontFamily:"var(--font-mono)",letterSpacing:"0.05em"},children:"SDK CODE EXAMPLES"}),e.jsx("div",{style:{display:"flex",gap:"8px",marginBottom:"12px"},children:["python","nodejs","go","rust"].map(o=>e.jsx("button",{onClick:()=>x(o),style:{padding:"8px 16px",background:a===o?"rgba(251, 191, 36, 0.2)":"rgba(107, 114, 128, 0.1)",border:`1px solid ${a===o?"rgba(251, 191, 36, 0.4)":"rgba(107, 114, 128, 0.2)"}`,color:a===o?"#fbbf24":"#6b7280",fontSize:"10px",fontWeight:700,fontFamily:"var(--font-mono)",cursor:"pointer",letterSpacing:"0.05em"},children:o.toUpperCase()},o))}),e.jsx(B,{language:a,code:s[a]})]})]})]})}export{q as IntegrationsPremium};
//# sourceMappingURL=IntegrationsPremium-BqzzBUzF.js.map
