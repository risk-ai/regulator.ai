...
export type NavSection = 'now' | 'runtime' | 'fleet' | 'workspace' | 'approvals' | 'policies' | 'policy-templates' | 'agent-templates' | 'activity' | 'intent' | 'action-types' | 'integrations' | 'compliance' | 'history' | 'services' | 'api-keys' | 'executions' | 'settings';
...
const PRIMARY_NAV: NavItem[] = [
  ...
  { id: 'executions', label: 'Executions', description: 'Execution monitoring', icon: '⚙️' },
