...
export function createPoliciesRouter(viennaRuntime) {
    const router = Router();
    /**
    ...
    router.post('/', async (req, res) => {
        try {
            ...
            const tenant_id = 'default';
            const created_by = req.session?.operator || 'unknown';
     ...
     */
    router.patch('/:policy_id', async (req, res) => {
        try {
            const { policy_id } = req.params;
     ...
     */
    router.post('/:policy_id/test', async (req, res) => {
        try {
            const { policy_id } = req.params;
