    ...
    try {
        ...
        if (!operatorPassword) {
            ...
            if (process.env.NODE_ENV === 'production') {
                ...
                process.env.VIENNA_OPERATOR_PASSWORD = generatedPassword;
            }
            else {
                console.warn('WARNING: VIENNA_OPERATOR_PASSWORD not set. Using "vienna-dev" for local development.');
                process.env.VIENNA_OPERATOR_PASSWORD = 'vienna-dev';
            }
        }
        ...
        if (!process.env.VIENNA_SESSION_SECRET) {
            ...
            process.env.VIENNA_SESSION_SECRET = generated;
        }
        ...
        const systemNowService = new SystemNowService(viennaRuntime, runtimeStatsService, providerHealthService, objectivesService);
        ...
        // Create Express app
        const app = createApp(viennaRuntime, chatService, bootstrapService, objectivesService, authService, timelineService, runtimeStatsService, providerHealthService, systemNowService, agentIntentBridge);
        ...
        eventStream.publish = function (event) {
