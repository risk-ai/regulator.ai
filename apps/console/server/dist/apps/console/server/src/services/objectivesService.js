...
export class ObjectivesService {
     ...
     * Cancel objective
     */
    async cancelObjective(objectiveId, operator, reason) {
        try {
     ...
     * Retry dead letter
     */
    async retryDeadLetter(deadLetterId, operator, reason) {
        try {
...
//# sourceMappingURL=objectivesService.js.map