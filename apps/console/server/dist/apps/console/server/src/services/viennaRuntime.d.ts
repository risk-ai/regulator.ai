...
export declare class ViennaRuntimeService {
    ...
    private _mapObjectiveStatus;
    private _inferRiskTier;
    ...
    private _getDefaultSystemStatus;
    private _getDefaultQueueState;
    private _getDefaultHealth;
    /**
