...
import { ExecutionHandler, ExecutionContext, ExecutionResult } from '../types.js';
import { query } from '../../db/postgres.js';

export const listAgentsHandler: ExecutionHandler = {
  name: 'list-agents',
  ...
  async execute(context: ExecutionContext): Promise<ExecutionResult> {
    try {
      ...
      // Count by status
      const statusCounts = formattedAgents.reduce((acc: any, agent: any) => {
