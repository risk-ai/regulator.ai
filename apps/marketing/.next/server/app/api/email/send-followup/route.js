(()=>{var e={};e.id=4556,e.ids=[4556],e.modules={10846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},44870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},29294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},63033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},57804:(e,t,i)=>{"use strict";i.r(t),i.d(t,{patchFetch:()=>g,routeModule:()=>l,serverHooks:()=>c,workAsyncStorage:()=>d,workUnitAsyncStorage:()=>f});var o={};i.r(o),i.d(o,{POST:()=>p});var n=i(42706),r=i(28203),a=i(45994),s=i(39187);async function p(e){try{let{email:t,name:i,template:o,company:n}=await e.json();if(!t||!i||!o)return s.NextResponse.json({error:"Email, name, and template are required"},{status:400});let r=process.env.RESEND_API_KEY;if(!r)return s.NextResponse.json({error:"Email service not configured"},{status:500});let a="",p="";switch(o){case"getting-started":a="Ready to Create Your First AI Policy?",p=function({name:e,email:t}){let i=e.split(" ")[0];return`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div style="max-width:600px;margin:0 auto;background-color:#ffffff;color:#333333;">
  ...
  <div style="padding:40px 30px;">
    <p style="font-size:16px;line-height:1.5;margin:0 0 24px;color:#4a5568;">Hi ${i},</p>
...
&nbsp;&nbsp;"enabled": true<br/>
  ...
  <div style="background-color:#f7fafc;padding:24px 30px;border-top:1px solid #e2e8f0;text-align:center;">
    ...
    <p style="margin:0;font-size:12px;color:#a0aec0;">Sent to ${t} • <a href="#" style="color:#667eea;">Unsubscribe</a></p>
  </div>
</div>

</body>
</html>
  `.trim()}({name:i,email:t});break;case"week-one":a="Ready for Production? Vienna OS Week 1 Tips",p=function({name:e,email:t}){let i=e.split(" ")[0];return`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div style="max-width:600px;margin:0 auto;background-color:#ffffff;color:#333333;">
  ...
  `.trim()}({name:i,email:t});break;case"pilot-offer":a="Exclusive: Vienna OS Pilot Program Invitation",p=function({name:e,email:t,company:i}){let o=e.split(" ")[0];return`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div style="max-width:600px;margin:0 auto;background-color:#ffffff;color:#333333;">
  ...
  <!-- Content -->
  <div style="padding:40px 30px;">
    <p style="font-size:16px;line-height:1.5;margin:0 0 24px;color:#4a5568;">Hi ${o},</p>
    ...
    <div style="background-color:#e6fffa;border:3px solid #38b2ac;border-radius:16px;padding:32px;margin:32px 0;position:relative;">
      ...
      <p style="font-size:16px;line-height:1.6;color:#285e61;margin:0 0 24px;">We're inviting select${i?` companies like ${i}`:" organizations"} to participate in our guided pilot program. Get:</p>
  ...
  `.trim()}({name:i,email:t,company:n});break;default:return s.NextResponse.json({error:"Invalid template"},{status:400})}return await fetch("https://api.resend.com/emails",{method:"POST",headers:{Authorization:`Bearer ${r}`,"Content-Type":"application/json"},body:JSON.stringify({from:"Vienna OS <hello@regulator.ai>",to:[t],subject:a,html:p})}),console.log(`[EmailFollowup] Sent ${o} email to ${t}`),s.NextResponse.json({success:!0,message:`${o} email sent successfully`,template:o,recipient:t})}catch(e){return console.error("Follow-up email error:",e),s.NextResponse.json({error:"Internal server error"},{status:500})}}let l=new n.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/email/send-followup/route",pathname:"/api/email/send-followup",filename:"route",bundlePath:"app/api/email/send-followup/route"},resolvedPagePath:"/home/agentsnet/.openclaw/workspace/regulator.ai/apps/marketing/src/app/api/email/send-followup/route.ts",nextConfigOutput:"standalone",userland:o}),{workAsyncStorage:d,workUnitAsyncStorage:f,serverHooks:c}=l;function g(){return(0,a.patchFetch)({workAsyncStorage:d,workUnitAsyncStorage:f})}},96487:()=>{},78335:()=>{}};var t=require("../../../../webpack-runtime.js");t.C(e);var i=e=>t(t.s=e),o=t.X(0,[638,5452],()=>i(57804));module.exports=o})();