    ...
    <div className="min-h-screen bg-navy-900">
      ...
      <main className="max-w-5xl mx-auto px-6 py-16">
          ...
          <ScrollReveal>
            <div className="text-center mb-12">
              <h1 className="text-5xl md:text-6xl font-bold mb-8 tracking-tight">
                ...
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 via-amber-500 to-blue-500">
        ...
        <ScrollReveal delay={0.2}>
          <section className="mb-24">
            <div className="bg-gradient-to-br from-amber-900/20 to-navy-800 border border-amber-500/30 rounded-2xl p-8 md:p-10">
              ...
              <div className="bg-navy-800/50 border border-amber-500/20 rounded-xl p-6">
        ...
        <ScrollReveal delay={0.5}>
          <section className="mb-24">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-navy-800 border border-navy-700 rounded-xl p-8 hover:border-amber-500/30 transition-colors">
        ...
        <ScrollReveal delay={0.7}>
          <section>
            <div className="bg-gradient-to-br from-amber-900/30 to-navy-800 border border-amber-500/30 rounded-2xl p-10 text-center">
              ...
              <div className="flex items-center justify-center gap-6">
                <a href="/signup" className="bg-amber-500 hover:bg-amber-400 text-white px-8 py-3 rounded-xl transition font-semibold shadow-lg hover:shadow-amber-500/25">
                  Get Started Free
                </a>
