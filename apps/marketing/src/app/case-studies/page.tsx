        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              {/* CTA */}
              <div className="bg-gradient-to-br from-amber-900/30 to-navy-800/50 border border-amber-500/20 rounded-xl p-5">
  ...
  return (
    <div className="min-h-screen bg-navy-950">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        {/* CTA */}
        <div className="mt-16 bg-gradient-to-br from-amber-900/30 to-navy-800/50 border border-amber-500/20 rounded-2xl p-8 text-center">
