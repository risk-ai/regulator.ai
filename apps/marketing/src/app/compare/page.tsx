          ...
          {[
            ...
            <div
              ...
              className={`p-5 border transition-all ${
                l.active
                  ? "bg-amber-500/10 border-amber-500/40 shadow-lg shadow-gold-400/10 scale-105"
                  : "bg-zinc-900/50 border-zinc-800"
              }`}
            >
              <div className={`text-xs font-bold uppercase tracking-wider mb-2 ${l.active ? "text-gold-300" : "text-zinc-500"}`}>
                {l.layer}
              </div>
          ...
          <table className="w-full">
              ...
              <tr className="border-b border-zinc-800">
                ...
                {competitors.map((c) => (
                  <th key={c.name} className={`text-center py-4 px-3 ${c.highlight ? "bg-amber-500/5" : ""}`}>
                    <div className={`text-sm font-bold ${c.highlight ? "text-gold-300" : "text-zinc-300"}`}>{c.name}</div>
            ...
            <tbody>
              {featureRows.map((row, i) => {
                ...
                return (
                  <>
                    ...
                    <tr key={row.key} className="border-b border-zinc-800 hover:bg-zinc-900/30 transition">
              ...
              <tr className="border-b border-zinc-800">
                ...
                {competitors.map((c) => (
                  <td key={c.name} className={`text-center py-3 px-3 text-xs text-zinc-400 ${c.highlight ? "bg-amber-500/5" : ""}`}>
        ...
        <div className="mt-16 bg-black border border-amber-500/20 p-8 text-center">
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap">
            <a
              ...
              className="bg-gold-500 hover:bg-amber-500 text-white px-8 py-3 transition font-semibold text-sm inline-flex items-center gap-2"
            >
            ...
            <a
              ...
              className="bg-zinc-900 hover:bg-amber-500/30 text-white px-8 py-3 transition text-sm border border-zinc-800"
            >
              Try the Playground
            </a>
          </div>
