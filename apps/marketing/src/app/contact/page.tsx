          ...
          <ScrollReveal>
            <div className="text-center py-20">
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <a href="/docs" className="bg-amber-500 hover:bg-amber-400 text-white px-6 py-2.5 rounded-xl transition font-medium">
                  Explore Docs
                </a>
              </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input 
                        ...
                        className="w-full bg-navy-900 border border-navy-600 rounded-xl px-4 py-3 text-white text-sm focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500/50 transition-colors" 
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      rows={6}
                      className="w-full bg-navy-900 border border-navy-600 rounded-xl px-4 py-3 text-white text-sm focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500/50 transition-colors resize-none"
                  ...
                  <button 
                    type="submit" 
                    disabled={sending}
                    className="w-full flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-400 disabled:opacity-50 disabled:cursor-not-allowed text-white px-8 py-3 rounded-xl transition font-semibold shadow-lg hover:shadow-amber-500/25"
                  >
