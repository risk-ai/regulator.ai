...
pip install vienna-os
        ...
        <div className="mb-12">
          ...
          <p className="text-slate-400 mb-4">
            Get your API key from <a href="https://console.regulator.ai" className="text-amber-500 hover:text-amber-400 underline" target="_blank" rel="noopener noreferrer">console.regulator.ai → API Keys</a> and initialize the Vienna client:
          </p>
...
// Use result.warrant to prove authorization`}
        ...
        {/* Next Steps */}
        <div className="bg-gradient-to-br from-amber-900/20 to-navy-800/50 border border-amber-500/20 rounded-2xl p-8">
          <h2 className="text-xl font-bold text-white mb-4">Next Steps</h2>
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            <a 
              href="/docs/github-action" 
              className="bg-[#141820] border border-[#1C222E] rounded-lg p-4 hover:border-amber-500/30 transition group"
            >
