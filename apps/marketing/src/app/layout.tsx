  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className={`${inter.variable} ${jetbrains.variable} ${inter.className}`}>
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-50 focus:bg-gold-400 focus:text-black focus:px-4 focus:py-2 focus:focus:text-sm focus:font-medium"
        >
