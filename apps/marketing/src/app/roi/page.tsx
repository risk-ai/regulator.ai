      ...
      <div className="max-w-5xl mx-auto px-6 pb-24">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <h2 className="text-lg font-semibold text-zinc-200">Your Environment</h2>
            
            <div>
              <label className="block text-sm text-zinc-400 mb-2">Number of AI agents</label>
              <input
              ...
              <div className="flex justify-between text-sm mt-1">
                ...
                <span className="text-amber-500 font-medium">{agents} agents</span>
                <span className="text-zinc-500">100</span>
              </div>
            </div>

            <div>
              <label className="block text-sm text-zinc-400 mb-2">Actions per day (all agents combined)</label>
              <input
              ...
              <div className="flex justify-between text-sm mt-1">
                ...
                <span className="text-amber-500 font-medium">{actionsPerDay.toLocaleString()}/day</span>
                <span className="text-zinc-500">10K</span>
              </div>
            </div>

            <div>
              <label className="block text-sm text-zinc-400 mb-2">Average cost per AI incident</label>
              <input
              ...
              <div className="flex justify-between text-sm mt-1">
                ...
                <span className="text-amber-500 font-medium">{fmt(avgIncidentCost)}</span>
                <span className="text-zinc-500">$500K</span>
              </div>
            </div>

            <div>
              <label className="block text-sm text-zinc-400 mb-2">Estimated AI incidents per year (without governance)</label>
              <input
              ...
              <div className="flex justify-between text-sm mt-1">
                <span className="text-zinc-500">1</span>
                <span className="text-amber-500 font-medium">{incidentsPerYear}/year</span>
                <span className="text-zinc-500">24</span>
              </div>
            </div>

            <div>
              <label className="block text-sm text-zinc-400 mb-2">Hours spent on compliance/audit per week</label>
              <input
              ...
              <div className="flex justify-between text-sm mt-1">
                ...
                <span className="text-amber-500 font-medium">{complianceHoursPerWeek} hrs/week</span>
                <span className="text-zinc-500">80</span>
              </div>
            </div>

            <div>
              <label className="block text-sm text-zinc-400 mb-2">Fully loaded hourly rate (compliance team)</label>
              <input
              ...
              <div className="flex justify-between text-sm mt-1">
                <span className="text-zinc-500">$50</span>
                <span className="text-amber-500 font-medium">{fmt(hourlyRate)}/hr</span>
          ...
          {/* Results */}
          <div className="space-y-6">
            <h2 className="text-lg font-semibold text-zinc-200">Estimated Annual Savings</h2>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between bg-black border border-amber-500/30 p-4">
                ...
                <p className="text-zinc-400 font-medium">-{fmt(roi.viennaCost)}</p>
              </div>
            </div>

            {/* Without governance */}
            <div className="bg-red-950/30 border border-red-500/20 p-4">
            ...
            <div className="flex gap-3 pt-4">
              <Link
                href="/signup"
                className="flex-1 text-center px-6 py-3 bg-amber-500 hover:bg-amber-500 font-medium transition"
              >
                Start Free
              </Link>
              <Link
                href="/try"
                className="flex-1 text-center px-6 py-3 border border-zinc-800 hover:border-amber-500/30 font-medium transition"
              >
                Try Demo
              </Link>
            </div>
        ...
        <div className="mt-16 text-center">
          <p className="text-xs text-zinc-500 max-w-2xl mx-auto">
            ...
            <Link href="/case-studies" className="text-amber-500 hover:underline">case studies</Link> for real-world examples.
          </p>
        </div>
      </div>
    </main>
