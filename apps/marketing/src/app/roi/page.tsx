      ...
      <div className="max-w-5xl mx-auto px-6 pb-24">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* Hero ROI number */}
            <div className="bg-gradient-to-br from-amber-500/20 to-cyan-600/20 border border-amber-500/30 rounded-2xl p-8 text-center">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between bg-slate-900/50 border border-amber-500/30 rounded-lg p-4">
                <div className="flex items-center gap-3">
            ...
            <div className="flex gap-3 pt-4">
              <Link
                href="/signup"
                className="flex-1 text-center px-6 py-3 bg-amber-500 hover:bg-amber-500 rounded-lg font-medium transition"
              >
                Start Free
              </Link>
              <Link
