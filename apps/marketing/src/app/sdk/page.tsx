    ...
    <div className="min-h-screen flex flex-col relative overflow-x-hidden bg-[#0a0e14] text-white">
      ...
      <main className="flex-1 relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="mb-12">
            ...
            <h1 className="text-5xl md:text-6xl font-mono font-bold tracking-tight leading-tight mb-6">
              <span className="text-gold-400">VIENNA_OS_SDKS</span>
              <br />
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="mb-12">
            <h2 className="text-3xl font-mono font-bold text-gold-400 uppercase mb-8">INSTALLATION</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-black border border-gold-400/30 p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-sm font-mono uppercase font-bold text-gold-400">JavaScript / TypeScript</h3>
                    <p className="text-xs font-mono text-zinc-500">via npm</p>
                  </div>
                </div>
                <div className="bg-zinc-900 border border-gold-400/20 p-4 font-mono text-xs text-gold-400 overflow-x-auto mb-4">
              ...
              <div className="bg-black border border-gold-400/30 p-6">
                <div className="flex items-center gap-3 mb-4">
                  <Package className="w-5 h-5 text-gold-400" />
                  <div>
                    <h3 className="text-sm font-mono uppercase font-bold text-gold-400">Python</h3>
        ...
        {/* Quick Start */}
        <div className="max-w-7xl mx-auto px-6 py-16">
          <h2 className="text-3xl font-mono font-bold text-gold-400 uppercase mb-8">QUICK_START</h2>
          <div className="bg-black border border-gold-400/30 p-6 overflow-x-auto">
...
const proposal = await vienna.proposals.create({
  ...
  action: 'send_email'
        ...
        {/* Features */}
        <div className="max-w-7xl mx-auto px-6 py-16">
          <h2 className="text-3xl font-mono font-bold text-gold-400 uppercase mb-8">FEATURES</h2>
          
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-black border border-gold-400/30 p-6">
              <div className="flex items-center gap-3 mb-4">
                <Zap className="w-5 h-5 text-gold-400" />
                <h3 className="text-sm font-mono uppercase font-bold text-gold-400">Simple API</h3>
              </div>
            ...
            <div className="bg-black border border-gold-400/30 p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-sm font-mono uppercase font-bold text-gold-400">Type Safety</h3>
              </div>
              <p className="text-xs font-mono text-zinc-400">
            ...
            <div className="bg-black border border-gold-400/30 p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-sm font-mono uppercase font-bold text-gold-400">Async/Await</h3>
              </div>
              <p className="text-xs font-mono text-zinc-400">
            ...
            <div className="bg-black border border-gold-400/30 p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-sm font-mono uppercase font-bold text-gold-400">Webhook Handlers</h3>
              </div>
              <p className="text-xs font-mono text-zinc-400">
        ...
        {/* Resources */}
        <div className="max-w-7xl mx-auto px-6 py-16">
          <h2 className="text-3xl font-mono font-bold text-gold-400 uppercase mb-8">RESOURCES</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              <Book className="w-6 h-6 text-gold-400 mb-4" />
              <h3 className="text-sm font-mono uppercase font-bold text-gold-400 mb-2">API Reference</h3>
              <p className="text-xs font-mono text-zinc-400 mb-4">
                Complete API documentation with examples for every endpoint.
              </p>
              <div className="flex items-center gap-2 text-gold-400 font-mono text-xs uppercase group-hover:gap-3 transition-all">
                Read Docs
            ...
            >
              ...
              <h3 className="text-sm font-mono uppercase font-bold text-gold-400 mb-2">GitHub Repository</h3>
              <p className="text-xs font-mono text-zinc-400 mb-4">
            ...
            >
              ...
              <h3 className="text-sm font-mono uppercase font-bold text-gold-400 mb-2">Example Projects</h3>
              <p className="text-xs font-mono text-zinc-400 mb-4">
        ...
        {/* CTA */}
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="bg-black border border-gold-400/30 p-12">
            <div className="text-[10px] font-mono text-zinc-600 uppercase tracking-widest mb-3">Ready?</div>
            <h2 className="text-3xl font-mono font-bold text-gold-400 uppercase mb-4">
              READY_TO_BUILD
            </h2>
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/signup"
                className="inline-flex items-center gap-2 px-8 py-4 bg-gold-400 hover:bg-gold-300 text-black font-mono font-bold uppercase text-sm transition"
              >
                GET_STARTED_FREE →
                <ArrowRight className="w-4 h-4" />
              </Link>
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 px-8 py-4 bg-zinc-900 border border-gold-400/30 hover:border-gold-400 text-gold-400 font-mono font-bold uppercase text-sm transition"
              >
                TALK_TO_SALES
              </Link>
            </div>
