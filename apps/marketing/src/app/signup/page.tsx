        ...
        {step === "plan" && (
          <>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-amber-500 hover:bg-amber-400 text-white px-8 py-3 rounded-xl transition font-medium"
            >
            ...
            <form onSubmit={handleSubmit} className="max-w-lg space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-navy-800 border border-navy-700 rounded-lg px-4 py-2.5 text-white text-sm focus:border-amber-500 focus:outline-none transition"
              ...
              <button
                type="submit"
                disabled={submitting}
                className="inline-flex items-center gap-2 bg-amber-500 hover:bg-amber-400 text-white px-8 py-3 rounded-xl transition font-medium disabled:opacity-50"
              >
              ...
              <>
                ...
                <div className="bg-navy-800 border border-navy-700 rounded-xl p-6 mb-6">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 bg-amber-500 hover:bg-amber-400 text-white px-6 py-2.5 rounded-lg transition font-medium text-sm"
                  >
                ...
                <div className="bg-navy-800 border border-navy-700 rounded-xl p-6 mb-6">
                  ...
                  <p className="text-sm text-slate-400">
                    Go to <span className="text-amber-500 font-medium">API Keys</span> in the console sidebar and create your first key. You&apos;ll get a <code className="text-xs bg-navy-900 px-1.5 py-0.5 rounded text-emerald-400">vos_</code> prefixed token.
                  </p>
                </div>
