...
export default function TryPage() {
      ...
      <nav className="border-b border-slate-700/50 backdrop-blur-sm bg-slate-950/80 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="/signup"
              className="text-sm bg-amber-500/10 text-amber-500 hover:bg-amber-500/20 border border-amber-500/20 px-4 py-1.5 rounded-lg transition font-medium"
            >
              Get Started
            </a>
          </div>
          ...
          <div className="space-y-3">
              ...
              <div className="bg-slate-800 border border-slate-700/50 rounded-xl p-4 space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className="w-full mt-3 flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-400 text-white text-sm font-medium px-4 py-2 rounded-lg transition"
                  >
                ...
                <div>
                  ...
                  {customParams.map((p, i) => (
                    <div key={i} className="flex gap-1.5 mb-1.5">
                      <input
                        className="flex-1 bg-slate-900 border border-navy-600 rounded-lg px-2.5 py-1.5 text-sm text-white placeholder:text-slate-500 focus:border-amber-500/40 focus:outline-none transition"
                        placeholder="key"
                        value={p.key}
                        onChange={(e) => {
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 text-xs text-amber-500 hover:text-amber-400 transition mt-1"
                  >
            ...
            <div className="sticky top-4 z-10 space-y-2">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-amber-500 to-amber-500 hover:from-amber-500 hover:to-amber-400 disabled:from-amber-500/50 disabled:to-amber-500/50 text-slate-950 font-bold px-6 py-4 rounded-xl transition text-sm shadow-lg shadow-amber-500/20"
              >
                {loading ? (
                  <>
              ...
              <button
                ...
                disabled={loading || runningAllScenarios}
                className="w-full flex items-center justify-center gap-2 bg-amber-500/90 hover:bg-amber-400 disabled:bg-amber-500/30 text-white font-medium px-4 py-3 rounded-lg transition text-sm"
              >
                {runningAllScenarios ? (
                  <>
          ...
          <div className="min-w-0" ref={pipelineRef}>
                        ...
                        <div className="flex flex-wrap items-center gap-2 justify-center">
                          {["Intent Gateway", "Policy Engine", "Risk Assessment", "Approval Gate", "Warrant Issuer", "Execution Router", "Verification Engine", "Audit Logger"].map((step, i) => (
                            <div key={step} className="flex items-center">
                              <div className="bg-slate-900/50 border border-slate-700/50 rounded-lg p-3 text-center group hover:border-amber-500/30 hover:bg-amber-500/5 transition-all duration-300 min-w-[100px]">
            ...
            {result && activeTab === "policies" && (
              <div className="space-y-3">
                  ...
                  <div className="divide-y divide-slate-700/30">
                    {result.policy_rules.map((rule) => (
                      <div key={rule.rule_id} className={`px-5 py-3 flex items-start gap-3 ${rule.matched ? "" : "opacity-50"}`}>
                        ...
                        <span className={`text-[10px] font-mono flex-shrink-0 ${rule.matched ? "text-amber-500" : "text-slate-600"}`}>
                ...
                <a
                  href="/docs/policies"
                  className="flex items-center justify-center gap-2 bg-amber-500/10 border border-amber-500/20 text-amber-500 hover:bg-amber-500/15 rounded-xl px-4 py-3 transition text-sm font-medium"
                >
                ...
                <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl overflow-hidden">
                  ...
                  <div className="p-5 space-y-4">
                    ...
                    <div className="flex items-center gap-2 overflow-x-auto py-3">
                      {[
                        ...
                        <div key={i} className="flex items-center gap-2 flex-shrink-0">
                          ...
                          <div className={`border rounded-lg p-3 min-w-[140px] ${block.current ? 'border-amber-500/50 bg-amber-500/5' : 'border-navy-600 bg-slate-800/50'}`}>
                    ...
                    <div className="bg-amber-500/5 border border-amber-500/20 rounded-lg p-3">
                      <div className="text-xs text-amber-400 font-medium mb-1">Why this matters</div>
                      ...
                      {Object.entries(result.trust_score.components).map(([name, comp]) => (
                        <div key={name} className="flex items-center gap-3">
                          ...
                          <div className="flex-1 bg-slate-900 rounded-full h-2 overflow-hidden">
                            <div
                              className="h-full rounded-full bg-gradient-to-r from-amber-500 to-amber-500 transition-all duration-1000"
              ...
              <div className="space-y-3">
                <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl overflow-hidden">
                  <div className="bg-slate-800 border-b border-slate-700/50 px-5 py-3 flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-amber-500/20 text-amber-400">OWS v1.0</span>
                  </div>
                  <div className="p-5 space-y-4">
                    <p className="text-xs text-slate-400 leading-relaxed">
                    ...
                    <div className="bg-amber-500/5 border border-amber-500/20 rounded-lg p-3">
                      <div className="text-xs text-amber-400 font-medium mb-1">Interoperable</div>
                      <p className="text-[11px] text-slate-400 leading-relaxed">
                        ...
                        <a href="/docs/ows" className="text-amber-500 hover:underline ml-1">Read the spec →</a>
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {result && activeTab === "warrant" && result.delegation && (
              <div className="mt-3 bg-amber-500/5 border border-amber-500/20 rounded-xl p-4">
                <div className="flex items-center gap-2 mb-2">
                  <span className="v-status-dot v-status-info" />
                  <h4 className="text-sm font-semibold text-amber-400">Warrant Delegation</h4>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 text-[11px]">
                  ...
                  <div className="bg-slate-900/50 rounded p-2 col-span-2">
                    ...
                    <div className="font-mono text-amber-400">{result.delegation.scope_reduction.join(', ') || 'N/A'}</div>
                  </div>
                </div>
              </div>
            )}
            ...
            {result && activeTab === "pipeline" && animatingStep === -1 && (
              <div className={`mt-4 rounded-xl p-4 border transition-all duration-500 ${
                ...
                <div className="flex items-start justify-between gap-4 flex-wrap">
                  ...
                  <a
                    href="/signup"
                    className="flex-shrink-0 flex items-center gap-1.5 text-sm font-medium text-amber-500 hover:text-amber-400 transition"
                  >
  ...
  -d '{
    ...
    "context": { "environment": "production" }
                ...
                className="text-xs text-amber-500 hover:text-amber-400 transition px-2 py-1 border border-amber-500/20 rounded"
              >
                Copy cURL
              </button>
            </div>
...
{`curl -X POST https://api.vienna-os.dev/v1/agent/intent \\
  ...
  -d '{
    ...
    "context": { "environment": "production" }
          ...
          {/* Next Steps */}
          <div className="bg-gradient-to-r from-amber-900/20 to-slate-800/50 border border-amber-500/20 rounded-2xl p-6">
            ...
            <div className="grid sm:grid-cols-3 gap-3">
              <a 
                ...
                className="bg-amber-500 hover:bg-amber-400 text-white text-sm font-medium px-4 py-3 rounded-xl transition text-center"
              >
                Start Free Trial →
              </a>
              <a 
              ...
              <a 
                ...
                className="text-amber-500 hover:text-amber-400 border border-amber-500/30 hover:bg-amber-500/5 text-sm font-medium px-4 py-3 rounded-xl transition text-center"
              >
                Schedule Demo
              </a>
            </div>
      ...
      <footer className="border-t border-slate-700/30 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 flex items-center justify-between text-xs text-slate-500">
          ...
          <a href="/docs" className="text-amber-500 hover:text-amber-400 transition">Documentation →</a>
        </div>
      </footer>
    </div>
  );
  ...
  return (
    <button
      ...
      className={`
        ...
        ${active
          ? "border-amber-500/40 bg-amber-500/8 shadow-[0_0_20px_rgba(212,165,32,0.1)] ring-1 ring-amber-500/20"
          : "border-slate-700/50 bg-slate-800/50 hover:border-navy-600 hover:bg-slate-800"
        }
      `}
    >
      {active && (
        <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-amber-500 to-gold-600 rounded-l-xl"></div>
      )}
  ...
  return (
    <div>
      ...
      <input
        ...
        className="w-full bg-slate-900 border border-navy-600 rounded-lg px-3 py-2 text-sm text-white placeholder:text-slate-500 focus:border-amber-500/40 focus:outline-none transition"
      />
    </div>
  );
}
