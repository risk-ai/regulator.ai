...
export default function LeadCaptureModal({ isOpen, onClose, trigger, plan }: LeadCaptureModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative bg-gradient-to-br from-navy-800 to-navy-900 border border-gold-400/30 rounded-2xl p-6 max-w-md w-full shadow-xl">
        <button
          onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-navy-700/50 border border-navy-600 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-gold-400 focus:border-transparent"
              ...
              <button
                ...
                className="w-full bg-gold-400 hover:bg-gold-400 disabled:bg-gold-800 disabled:cursor-not-allowed text-white font-semibold px-6 py-3 rounded-xl transition flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
                  "Submitting..."
                ) : (
