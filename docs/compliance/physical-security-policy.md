...
This policy establishes physical security controls for Vienna OS infrastructure, ensuring appropriate protection of computing resources, data, and facilities. Vienna OS operates on cloud infrastructure provided by Vercel, with additional logical access controls implemented at the application layer.
...
Vienna OS operates exclusively on **Vercel** serverless infrastructure, which utilizes AWS and Google Cloud certified datacenter facilities with the following physical security controls:

**Datacenter Certifications:**
- SOC 2 Type II compliance (via AWS/GCP)
- ISO 27001:2013 certification
- Physical security audited annually by third-party assessors

**Vercel Infrastructure Security Controls:**
- **Perimeter Security:** AWS/GCP datacenter facilities with controlled access points, security guards, and surveillance systems
...
**Reference:** Vercel security documentation available at https://vercel.com/security

### 2.2 Vendor Due Diligence

**Annual Review Process:**
1. Review Vercel's SOC 2 Type II report and compliance certificates
...
- Vercel SOC 2 Type II report: Valid through December 2026
...
Vienna OS implements defense-in-depth logical access controls on top of Vercel's physical security:
...
- **Category 1 (Critical):** Unauthorized datacenter access, security breach at Vercel/AWS/GCP facilities
...
4. **Vendor Coordination:** Coordinate with Vercel on infrastructure incidents
...
- **Vendor Documentation:** Vercel compliance certificates and security reports
