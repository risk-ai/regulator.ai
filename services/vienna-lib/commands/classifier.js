...
exports.LayeredClassifier = void 0;
const parser_js_1 = require("./parser.js");
const keyword_js_1 = require("./keyword.js");
class LayeredClassifier {
    constructor(providerManager, config = {}) {
        this.parser = new parser_js_1.DeterministicCommandParser();
        this.keywordClassifier = new keyword_js_1.KeywordClassifier();
...
exports.LayeredClassifier = LayeredClassifier;
