...
class PolicyEngine {
    ...
    async _evaluateLedgerConstraints(constraints, plan, ledgerQueryResults) {
        ...
        if (constraints.must_not_have_status) {
            ...
            const last = ledgerQueryResults[cacheKey];
    ...
    // ─── Conflict Detection ───
    _detectPolicyConflicts(matchedPolicies, _plan) {
