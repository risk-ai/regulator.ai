...
exports.NaturalLanguagePolicyBuilder = void 0;
...
class NaturalLanguagePolicyBuilder {
    ...
    parse(input) {
        ...
        if (decisionFragment) {
            ...
            for (const t of decisionFragment.split(/\s+/))
                unmatchedTokens.delete(t);
        }
        ...
        if (envFragment) {
            ...
            for (const t of envFragment.split(/\s+/))
                unmatchedTokens.delete(t);
        }
        // 5. Extract risk tier
        ...
        if (tierFragment) {
            ...
            for (const t of tierFragment.split(/\s+/))
                unmatchedTokens.delete(t);
        }
        // 6. Extract actor
        ...
        if (actorFragment) {
            ...
            for (const t of actorFragment.split(/\s+/))
                unmatchedTokens.delete(t);
        }
        ...
        if (timeFragment) {
            ...
            for (const t of timeFragment.split(/\s+/))
                unmatchedTokens.delete(t);
        }
...
exports.NaturalLanguagePolicyBuilder = NaturalLanguagePolicyBuilder;
exports.default = NaturalLanguagePolicyBuilder;
