...
exports.T3_ACTIONS = exports.T2_ACTIONS = exports.T1_ACTIONS = exports.RiskTier = void 0;
...
class RiskTier {
     ...
     */
    classify(operation) {
        const { action = '', reversible = true, tradingImpact = 'none', blastRadius = 'single_file', requiresApproval = false, financialImpact = 0, piiInScope = false, regulatoryScope = false } = operation;
