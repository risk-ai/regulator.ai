...
exports.MerkleWarrantChain = void 0;
...
class MerkleWarrantChain {
    ...
    async verifyAgainstAnchor(tenantId, anchor) {
        ...
        const merkleRoot = this.computeMerkleRoot(chain.slice(0, anchor.chain_length).map((w) => w.content_hash));
...
exports.MerkleWarrantChain = MerkleWarrantChain;
exports.default = MerkleWarrantChain;
