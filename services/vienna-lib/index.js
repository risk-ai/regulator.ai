...
module.exports = {
    ...
    MerkleWarrantChain: require('./governance/warrant-chain.js'),
    InMemoryWarrantChainStore: require('./governance/warrant-chain-store.js').InMemoryWarrantChainStore,
    PostgresWarrantChainStore: require('./governance/warrant-chain-store.js').PostgresWarrantChainStore,
    // Open Warrant Standard
    OpenWarrantStandard: require('./governance/open-warrant-standard.js'),
    // Policy Simulation
    PolicySimulator: require('./governance/policy-simulator.js'),
    // Warrant Delegation
    WarrantDelegation: require('./governance/warrant-delegation.js'),
    // Agent Trust Scoring
    AgentTrustEngine: require('./governance/agent-trust-score.js'),
    // Natural Language Policy Builder
    NaturalLanguagePolicyBuilder: require('./governance/natural-language-policy-builder.js'),
    // Compliance Reports
    ComplianceReportGenerator: require('./compliance/report-generator.js'),
    // Runtime stub for console compatibility
    default: require('./governance/runtime-stub.js')
