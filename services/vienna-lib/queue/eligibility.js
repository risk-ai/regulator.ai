...
exports.isQueueItemEligible = isQueueItemEligible;
exports.compareQueueItems = compareQueueItems;
const state_machine_1 = require("./state-machine");
async function isQueueItemEligible(item, nowIso, deps) {
    // Terminal states are never eligible
    if ((0, state_machine_1.isTerminalState)(item.state)) {
...
async function evaluateResumeCondition(rc, nowIso, deps) {
    switch (rc.type) {
        case "lock_released": {
