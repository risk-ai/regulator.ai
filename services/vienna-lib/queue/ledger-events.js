...
exports.emitQueueLedgerEvent = emitQueueLedgerEvent;
exports.getQueueEventTypeFromTransition = getQueueEventTypeFromTransition;
const state_graph_1 = require("../state/state-graph");
async function emitQueueLedgerEvent(eventType, queueItem, metadata) {
    const stateGraph = (0, state_graph_1.getStateGraph)();
...
function getQueueEventTypeFromTransition(fromState, toState) {
