...
exports.incrementRetryAttempt = incrementRetryAttempt;
function computeNextRetryAt(now, retry, policy) {
...
function shouldRetry(retry, policy) {
    return retry.attempt_count < policy.max_attempts;
}
function incrementRetryAttempt(retry, error) {
    return {
