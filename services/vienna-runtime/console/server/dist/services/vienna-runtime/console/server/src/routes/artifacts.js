...
router.get('/', async (req, res) => {
    try {
        const { investigation_id, artifact_type, intent_id, execution_id, objective_id, limit = 50, offset = 0, } = req.query;
...
router.post('/', async (req, res) => {
    try {
        const { artifact_type, name, content, investigation_id, intent_id, execution_id, objective_id, incident_id, } = req.body;
