...
async function start() {
    try {
        ...
        // Create Express app
        const app = createApp(viennaRuntime, chatService, bootstrapService, objectivesService, authService, timelineService, runtimeStatsService, providerHealthService, systemNowService);
