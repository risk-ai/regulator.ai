...
function createApprovalRequest(params) {
    const { execution_id, plan_id, step_id, intent_id, required_tier, required_by, requested_by, ttl_seconds = 3600, // Default 1 hour
    action_summary, risk_summary, target_entities, estimated_duration_ms, rollback_available = false } = params;
    // Validation
