...
class CrashRecoveryManager {
    ...
    async runRecovery() {
        ...
        try {
            ...
            // Log summary
            console.log(`[CrashRecoveryManager] Recovery complete: ` +
    ...
    async recoverOrphanedEnvelope(entry) {
        ...
        if (!this.enableAutomaticRecovery) {
            ...
            console.log(`[CrashRecoveryManager] Envelope ${entry.envelope_id} requeued ` +
    ...
    async validateQueueConsistency() {
        ...
        const longRunning = allEntries.filter(e => {
            if (e.state !== 'executing' || !e.started_at)
                return false;
...
//# sourceMappingURL=crash-recovery-manager.js.map