...
function validateObjective(objective) {
    ...
    if (!objective.target_id)
        errors.push('target_id is required');
    if (!objective.desired_state)
        errors.push('desired_state is required');
    if (!objective.remediation_plan)
        errors.push('remediation_plan is required');
    if (!objective.evaluation_interval)
        errors.push('evaluation_interval is required');
    // Type validation
