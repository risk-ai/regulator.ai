...
class FederatedLedger {
    ...
    async reconcileEvents(reconciliation) {
        ...
        for (const missingEvent of missing) {
            const remoteEvent = await this.nodeClient.fetchRemoteLedger(missingEvent.node_id, { event_id: missingEvent.event_id });
...
//# sourceMappingURL=federated-ledger-memory.js.map