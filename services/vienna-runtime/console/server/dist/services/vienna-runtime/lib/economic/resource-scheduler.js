...
class ResourceScheduler {
    ...
    async _filterByBudget(paths, context) {
        ...
        for (const path of paths) {
            const affordability = await this.budgetManager.checkAffordability({ compute_class: 'compute:medium', estimated_tokens: 1000 }, { ...context, estimated_cost: path.estimated_cost });
