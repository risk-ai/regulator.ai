 ...
 */
export type QueueState = "READY" | "BLOCKED_LOCK" | "BLOCKED_APPROVAL" | "BLOCKED_DEPENDENCY" | "RETRY_SCHEDULED" | "RUNNING" | "COMPLETED" | "FAILED" | "CANCELLED";
export type TerminalQueueState = "COMPLETED" | "FAILED" | "CANCELLED";
export type RetryEligibleQueueState = "BLOCKED_LOCK" | "BLOCKED_DEPENDENCY" | "RETRY_SCHEDULED";
export type QueueBlockReason = "LOCK_CONFLICT" | "APPROVAL_REQUIRED" | "APPROVAL_PENDING" | "DEPENDENCY_PENDING" | "DEPENDENCY_FAILED" | "TRANSIENT_EXECUTION_ERROR" | "POLICY_RECHECK_DEFERRED" | "RATE_LIMITED";
...
export declare const QUEUE_PRIORITY_ORDER: Record<QueuePriority, number>;
...
export type QueueLedgerEventType = "QUEUE_ITEM_CREATED" | "QUEUE_ITEM_BLOCKED" | "QUEUE_ITEM_READY" | "QUEUE_ITEM_RETRY_SCHEDULED" | "QUEUE_ITEM_LEASE_ACQUIRED" | "QUEUE_ITEM_GOVERNANCE_REENTRY_STARTED" | "QUEUE_ITEM_GOVERNANCE_REENTRY_PASSED" | "QUEUE_ITEM_GOVERNANCE_REENTRY_REQUEUED" | "QUEUE_ITEM_GOVERNANCE_REENTRY_CANCELLED" | "QUEUE_ITEM_EXECUTION_STARTED" | "QUEUE_ITEM_EXECUTION_COMPLETED" | "QUEUE_ITEM_EXECUTION_FAILED" | "QUEUE_ITEM_CANCELLED";
