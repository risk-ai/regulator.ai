 ...
 */
function createPlan({ objective, intent_id = null, steps, preconditions = [], postconditions = [], risk_tier, estimated_duration_ms = 10000, verification_spec = null, metadata = {} }) {
    const now = Date.now();
    return {
 ...
 */
function createSimplePlan({ action, description, args = {}, executor, risk_tier, objective = null, verification_spec = null }) {
    const step = {
        step_number: 1,
        action,
        description,
