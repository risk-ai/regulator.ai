...
class InvestigationManager {
    ...
    `);
        stmt.run(objective_id, new Date().toISOString(), investigation_id, this.stateGraph.environment);
        // Create link note
        this.workspace.storeArtifact({
    ...
    updateStatus(investigation_id, status, updated_by, resolution_note = null) {
        const investigation = this.workspace.updateInvestigationStatus(investigation_id, status, updated_by);
...
//# sourceMappingURL=investigation-manager.js.map