...
class AttestationEngine {
     ...
     */
    async createAttestation({ execution_id, tenant_id = null, status, input_hash = null, output_hash = null, metadata = null }) {
    ...
    `);
        stmt.run(attestation.attestation_id, attestation.execution_id, attestation.tenant_id, attestation.status, attestation.input_hash, attestation.output_hash, attestation.attested_at, attestation.metadata, attestation.created_at);
        return attestation;
    }
    /**
...
//# sourceMappingURL=attestation-engine.js.map